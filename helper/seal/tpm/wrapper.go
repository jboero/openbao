...
//   - tpm_path:     TPM device path (default: /dev/tpmrm0)
//   - pcr_indexes:  comma-separated PCR indexes (e.g. "0,2,7")
//   - key_label:    label for the sealed object (default: openbao-seal)
func (w *Wrapper) SetConfig(_ context.Context, opts ...wrapping.Option) (*wrapping.WrapperConfig, error) {
	...
	// Generate a stable key ID from config
